<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddVerdict.aspx.cs" Inherits="SP1.AddVerdict" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text="Verdict :"></asp:Label>
                </td>
                <td class="auto-style3">
                    <asp:TextBox ID="Verdict" runat="server" TextMode="MultiLine" Width="550px"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Verdict" ErrorMessage="Verdict must need to be filled !"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td class="auto-style3">
                    <asp:Button ID="Submit" runat="server" BackColor="#33CCCC" Font-Bold="True" ForeColor="Black" Height="36px" Text="SUBMIT" Width="550px" OnClick="Submit_Click" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
