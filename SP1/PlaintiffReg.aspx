<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlaintiffReg.aspx.cs" Inherits="SP1.PlaintiffReg" %>
...
<head runat="server">
    <title>Plaintiff Registration</title>
...
<body>
    ...
    <div class="w3-main" id="main">
        ...
        <h1>Plaintiff Registration</h1>
        <table class="auto-style2">
            <tr>
                <td class="auto-style9"></td>
                <td class="auto-style10">
                    <asp:Button ID="ButtonPlaintiffExist" runat="server" BackColor="#33CCCC" Font-Bold="True" Font-Size="Large" ForeColor="Black" Text="Add An Existing Plaintiff" Width="421px" CausesValidation="False" OnClick="ButtonPlaintiffExist_Click" />
                </td>
            ...
            <tr>
                <td class="auto-style6">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Plaintiff Name :" Font-Size="Large"></asp:Label>
                </td>
