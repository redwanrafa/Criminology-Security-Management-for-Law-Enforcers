<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WitnessReg.aspx.cs" Inherits="SP1.WitnessReg" %>
    ...
    <h1>Witness Registration</h1>
        <table class="auto-style2">
            <tr>
                ...
                <td>
                    <asp:Button ID="ButtonNext" runat="server" BackColor="#33CCCC" CausesValidation="False" Font-Bold="True" Font-Size="Large" ForeColor="Black" Text="Finish -&gt;" Width="181px" OnClick="ButtonNext_Click" />
                </td>
            </tr>
            <tr>
