<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCriminal2.aspx.cs" Inherits="SP1.ViewCriminal2" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style9">
                    <asp:DropDownList ID="DropDownListCriminalStatus" runat="server" Enabled="False" Visible="False">
                        <asp:ListItem>On Custody</asp:ListItem>
                        <asp:ListItem>On Bail</asp:ListItem>
                        <asp:ListItem>Uncaptured</asp:ListItem>
                    </asp:DropDownList>
                    <asp:Button ID="Add" runat="server" Text="Add" BackColor="#33CCCC" Enabled="False" Font-Size="Large" ForeColor="Black" Visible="False" Width="50px" OnClick="Add_Click" PostBackUrl="ViewCriminal2.aspx" />
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style7" colspan="4">
                    <asp:Button ID="ButtonCriminal" runat="server" BackColor="#33CCCC" Font-Bold="True" Font-Size="Large" ForeColor="Black" Text="Update Criminal Status" Width="420px" CausesValidation="False" OnClick="ButtonCriminal_Click" Enabled="False" Visible="False" />
                </td>
            </tr>
            <tr>
