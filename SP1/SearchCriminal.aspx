<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchCriminal.aspx.cs" Inherits="SP1.Search" %>
...
<body>
    ...
    <div class="w3-main" id="main">
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="GridViewCriminalList" runat="server" OnSelectedIndexChanged="GridViewCriminalList_SelectedIndexChanged" Width="1280px">
                        <Columns>
