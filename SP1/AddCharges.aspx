<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCharges.aspx.cs" Inherits="SP1.AddCharges" %>
...
<body>
    ...
    <div class="w3-main" id="main">
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="GridViewCriminal" runat="server" OnSelectedIndexChanged="GridViewCriminal_SelectedIndexChanged" Width="1244px">
                        <Columns>
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="DropDownListCharges" runat="server">
                    </asp:DropDownList>
                    <asp:Button ID="Add" runat="server" Text="Add" OnClick="Add_Click" BackColor="#33CCCC" Font-Size="Large" ForeColor="Black" Height="23px" ValidationGroup="InvOff" Width="75px" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
