<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WitnessExisting2.aspx.cs" Inherits="SP1.WitnessExisting2" %>
...
<body>
    ...
    <h1>Search Witness</h1>
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style7">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Witness Name :" Font-Size="Large"></asp:Label>
                </td>
                <td class="auto-style5">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="GridViewWitnessList" runat="server" Width="1290px" OnSelectedIndexChanged="GridViewWitnessList_SelectedIndexChanged">
                        <Columns>
